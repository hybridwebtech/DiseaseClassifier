let testBPData = [ {SysBP: 120, DiaBP: 90, atDate: '2018/10/31'},{SysBP: 115, DiaBP: 100, atDate: '2018/10/20'}];

function hypertensionCalculator( bpData )
{
...
console.log( hypertensionCalculator( testBPData ) );
